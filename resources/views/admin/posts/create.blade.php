...
@section('content')
    <div class="max-w-3xl mx-auto">
        <h1 class="text-3xl font-bold text-onBackground mb-8">Create New Post</h1>

        <form method="POST" action="{{ route('admin.posts.store') }}" class="space-y-6 bg-surface p-6 rounded-lg shadow">
            @csrf
